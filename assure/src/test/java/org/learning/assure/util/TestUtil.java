...
public class TestUtil {
    ...
    public static OrderForm createValidOrder(Long clientId, Long customerId, String name) {
        OrderForm orderForm = new OrderForm();
        orderForm.setChannelName(name);
        orderForm.setClientId(clientId);
        orderForm.setCustomerId(customerId);
        orderForm.setChannelOrderId("mock-ch-order-1");
        List<ChannelOrderForm> channelOrderFormList = new ArrayList<>();
        ChannelOrderForm item1 = new ChannelOrderForm();
        item1.setChannelSkuId("cn1");
        item1.setOrderedQuantity(3L);
        item1.setSellingPricePerUnit(30.00);
        channelOrderFormList.add(item1);
        ChannelOrderForm item2 = new ChannelOrderForm();
        item2.setChannelSkuId("cn2");
        item2.setOrderedQuantity(3L);
        item2.setSellingPricePerUnit(30.00);
        channelOrderFormList.add(item2);
        orderForm.setChannelOrderFormList(channelOrderFormList);
        return orderForm;
    }

    public static OrderForm createInvalidOrder(Long clientId, Long customerId, String name) {
        ...
        List<ChannelOrderForm> channelOrderFormList = new ArrayList<>();
        ChannelOrderForm item1 = new ChannelOrderForm();
        item1.setChannelSkuId("cnx");
        item1.setOrderedQuantity(0L);
        item1.setSellingPricePerUnit(30.00);
        channelOrderFormList.add(item1);
        ChannelOrderForm item2 = new ChannelOrderForm();
        item2.setChannelSkuId("cnk");
        item2.setOrderedQuantity(3L);
        item2.setSellingPricePerUnit(30.00);
        channelOrderFormList.add(item2);
        orderForm.setChannelOrderFormList(channelOrderFormList);
    ...
    public static OrderForm createMissingItemsOrder(Long clientId, Long customerId, String name) {
        OrderForm orderForm = new OrderForm();
        orderForm.setChannelName(name);
        orderForm.setClientId(clientId);
        orderForm.setCustomerId(customerId);
